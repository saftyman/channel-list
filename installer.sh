...
# ###########################################
#
# Command: wget https://raw.githubusercontent.com/saftyman/channel-list/main/installer.sh -qO - | /bin/sh
#
# ###########################################
...
TMPDIR='/tmp'
PACKAGE='astra-sm'
MY_URL='https://raw.githubusercontent.com/saftyman/channel-list/main'
